...
public final class DefaultV1LocationsApi extends BaseApi implements V1LocationsApi {
     ...
     * @param authManagers
     */
    public DefaultV1LocationsApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers) {
     ...
     * @param httpCallback
     */
    public DefaultV1LocationsApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers, HttpCallback httpCallback) {
