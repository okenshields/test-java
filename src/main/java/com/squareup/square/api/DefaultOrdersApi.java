...
public final class DefaultOrdersApi extends BaseApi implements OrdersApi {
     ...
     * @param authManagers
     */
    public DefaultOrdersApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers) {
     ...
     * @param httpCallback
     */
    public DefaultOrdersApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers, HttpCallback httpCallback) {
    ...
    private HttpRequest buildCalculateOrderRequest(
        ...
        //prepare query string for API call
        StringBuilder queryBuilder = new StringBuilder(baseUri + "/v2/orders/calculate");
        //validate and preprocess url
        String queryUrl = ApiHelper.cleanUrl(queryBuilder);
     ...
     */
    private CalculateOrderResponse handleCalculateOrderResponse(HttpContext context)
            throws ApiException, IOException {
        HttpResponse response = context.getResponse();
